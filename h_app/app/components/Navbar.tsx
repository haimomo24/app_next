        ...
        <div>
            <div className='flex items-center justify-between py-4 relative'>
                <div className='flex items-center md:space-x-10 lg:space-x-20'>
                    <div className='font-semibold text-2xl'><a href="/">HH_STORE</a></div>
                    <nav className='max-md:hidden'>
                        <ul className='flex items-center lg:space-x-10 space-x-7 opacity-70 text-[15px]'>
                            <li >
                                <a href='/' className='py-3 inline-block w-full'>shop</a>
                            </li>

                            <li >
                                <a href='filters' className='py-3 inline-block w-full'>filters</a>
                            </li>

                            <li >
                                <a href='myproducts' className='py-3 inline-block w-full'>My Products </a>
                            </li>
                        </ul>
                    </nav>
                ...
                <div className='flex items-center space-x-4'>
                    ...
                    <span onClick={() => setShowNav(!showNav)} className='p-[9px] bg-gray-100 rounded-full md:hidden'>
                        <BsChevronCompactUp className={`transitin ease-in duration-150 ${showNav ? "rotate-180" : "0"}`} />
                    </span>
                </div>
            </div>
